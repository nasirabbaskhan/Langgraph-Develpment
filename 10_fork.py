...
def stream_graph_update(user_input:str):
    ...
    # We can re-run (Replying) and also update our agent from any of the prior steps.
    to_fork = all_states[-2] #  second last state
    ...
    # fork
    # we want it should replay and also update the  from second last state --> all_states[-2] 
