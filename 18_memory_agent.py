...
# #********************************* Defining lmemory tool********************************

# Update memory tool
class UpdateMemory(BaseModel):
    """ Decision on what memory type to update """
    update_type: Literal['user', 'todo', 'instructions'] = Field(description="The type of memory to update.")
...
class ToDo(BaseModel):
    task: str = Field(description="The task to be completed.") #Added description here
    time_to_complete: Optional[int] = Field(description="Estimated time to complete the task (minutes).", default=None)
...
def task_mAIstro(state: MessagesState, config: RunnableConfig, store: BaseStore):
    ...
    response = llm.bind_tools([UpdateMemory]).invoke([SystemMessage(content=system_msg)]+state["messages"])
